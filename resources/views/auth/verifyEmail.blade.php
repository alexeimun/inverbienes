...
<html lang="es">
    <head>
		<meta charset="utf-8">
		<title>Rhemo - confirmar correo</title>
        ...
        <div class="content">
            ...
            <footer class="padding centrar centrar-columna">
                <div>
                    ...
                    <p>Contactanos: <a href="mailto:info@rhemo.co">info@rhemo.co</a></p>
                    <p>El uso de la información en Rhemo esta sujeta a nuestros <a href="">Términos de uso</a> y <a href="">Políticas de privacidad</a></p>
                    <p>Rhemo es una marca Fechner. Todos los derechos reservados</p>
                </div>
                <div class="margin-20 centrar logo-footer">
                    <img src="/images/r_rhemo.png">
                </div>
            </footer>
        </div>
    </body>
